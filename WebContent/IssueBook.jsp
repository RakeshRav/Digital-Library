 ...
 <table align="center">
   <tr>
    <%
     ...
     %><td width="117" height="28" class="style1">ISBN No.</td>
    <TD width="167"><select name="isbn" onChange="change()">
             <%
     ...
     <tr>
     <td height="28" class="style1">Book ID</td>
     ...
     %><td height="26" class="style1">Student ID</td>
<TD><select name="stuid" onChange="change1()">
      ...
      <%
            ...
            rs=st.executeQuery("select fee,n_books from lms_registration where reg_id='"+(String)session.getAttribute("stuid")+"'");
      %>
    </select> </TD>
     </tr>
     <%  
          ...
          if(rs.next())
          {
              ...
              nbooks = rs.getInt(2);
          %>
     <tr><td height="28" class="style1">Amount Remaining</td>
     <td><input type="text" name="fee" value="<%=fee%>" readonly/></td><td width="96" class="style1">Min. Rs 300 </td>
     </tr>
     <tr>
     <td height="27" class="style1">No. of books issued</td>
     <td><input type="text" name="nbooks" value="<%=nbooks%>" readonly/></td><td class="style1">Max. 3 books</td>
     </tr>
          <%}else{%>
        <tr>  <td height="27" class="style1">Amount Remaining</td>
        <td><input type="text" name="fee" readonly/></td><td class="style1">Min. Rs 300 </td>
        </tr>
     <tr>
     <td height="28" class="style1">No. of books issued</td>
     <td><input type="text" name="nbooks"  readonly/></td><td class="style1">Max. 3 books</td>
     </tr>
                <%}%>
     <tr>
     <%
     ...
     %>
       ...
       <%
           ...
           { 
	  %>
             <td height="27" class="style1">Issue Date</td>
        <TD><input type="text" name="isuuedate" value="<%=rs.getString(1)%>" readonly></td></tr>
             
             <tr><td height="30" class="style1">Return Date</td>
