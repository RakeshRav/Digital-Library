...
<div id="sidebar">
 ...
 <th width="22%" bgcolor="#B59A31"><span class="style4">View</span></th>
 </tr>
     ...
     <%
        ...
        try
		{
            ...
            <tr>  <td bgcolor="#F7AF9B"><div align="center" class="style6"><%=rs.getString(1)%></div></td>
              ...
              <td bgcolor="#F7AF9B"><div align="center" class="style6"><a href="viewPdf.jsp?book_id=<%=rs.getString(2)%>">View</a></div></td></tr>
              <%
              }
