...
<div id="sidebar">
   ...
   <form name="register" action="./register" onsubmit="return fun()" method="post">
   <center>
     ...
     <tr>
      <%
        ...
        try
		{
            ...
            ResultSet rs=st.executeQuery("select reg_seq.nextval from dual");
           if(rs.next())
           { 
		
     %>
     <td width="120"><span class="style1">Student ID</span></td>
     <td width="184"><input type="text" name="regid" value="STU<%=rs.getString(1)%>" readonly></td>
     <%}
     }
        catch(Exception e)
		{
